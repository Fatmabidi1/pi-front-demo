...
export class DashboardComponent implements OnInit {
  ...
  constructor(public userService:UserService, public EventService:EventService, public DossierSponsoringService:SponsoringService , private router: Router, private calendar: NgbCalendar) {}
